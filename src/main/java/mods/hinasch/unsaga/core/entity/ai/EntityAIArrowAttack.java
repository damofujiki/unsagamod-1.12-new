...
//        UnsagaMod.logger.trace("attacktime", entitylivingbase);
    ...
    public void updateTask()
    {
        ...
        UnsagaMod.logger.trace(this.getClass().getName(), "update");
        if (flag)
        {
            ++this.field_75318_f;
        }
        ...
        else if (this.rangedAttackTime < 0)
        {
            ...
            this.rangedAttackTime = MathHelper.floor(f2 * (float)(this.maxRangedAttackTime - this.field_96561_g) + (float)this.field_96561_g);
        }
    }
}