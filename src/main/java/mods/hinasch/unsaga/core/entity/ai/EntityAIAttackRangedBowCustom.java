...
public class EntityAIAttackRangedBowCustom<T extends EntityCreature & IRangedAttackMob> extends EntityAIBase
{
    ...
    public EntityAIAttackRangedBowCustom(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_)
    {
